<style type="text/css">
	...
	#facebook, #twitter, #google-plus, #youtube, #rss, #instagram, #pinterest, #flickr { background-color:  <?php echo get_theme_mod('cor-1'); ?>; }
	#facebook:hover, #twitter:hover, #google-plus:hover, #youtube:hover, #rss:hover, #instagram:hover, #pinterest:hover, #flickr:hover { background-color: <?php echo get_theme_mod('cor-2'); ?>; }
